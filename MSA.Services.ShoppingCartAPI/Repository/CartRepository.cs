...
namespace MSA.Services.ShoppingCartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        async Task<bool> ICartRepository.ClearCart(string userId)
        {
        ...
        async Task<CartDto> ICartRepository.CreateUpdateCart(CartDto cartDto)
        {
        ...
        async Task<CartDto> ICartRepository.GetCartByUserID(string userId)
        {
            Cart cart = new()
            {
        ...
        async Task<bool> ICartRepository.RemoveFromCart(int cartDetailsId)
        {
            try
            {
